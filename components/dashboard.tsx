    ...
    <section aria-labelledby="overview-heading" className="dashboard">
      <header className="dashboard__header">
        <div>
          ...
          <h1 id="overview-heading">Find any family record in seconds.</h1>
          <p className="dashboard__intro">A synthetic sample vault is ready to explore. Every answer links back to the exact document it came from.</p>
        </div>
